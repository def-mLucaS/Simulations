...
class Monopile(ComponenteCilindrico):
    def __init__(self, diametro, altura, massa):
        ...
        self._tempo_fixacao_deck_embarcacao = tempo_processamento["tempo_fixacao_deck_monopile"]
        self._tempo_liberacao_deck_embarcacao = tempo_processamento["tempo_liberacao_deck_monopile"]
